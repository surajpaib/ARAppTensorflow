...
import org.tensorflow.demo.AROverlay;
...
public class MultiBoxTracker {
  ...
  public MultiBoxTracker(final Context context) {
    ...
    arOverlay = new AROverlay(this.context);
...
//      canvas.drawRect(rect, boxPaint);
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      arOverlay.drawAR(trackedPos, canvas, recognition.title);
      ////      canvas.drawRoundRect(trackedPos, cornerSize, cornerSize, boxPaint);
//      Drawable d = context.getResources().getDrawable(R.drawable.asset);
//      d.setBounds((int)trackedPos.left, (int)trackedPos.top, (int)trackedPos.right, (int)trackedPos.bottom);
//      d.draw(canvas);
